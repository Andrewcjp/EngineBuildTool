...
namespace EngineBuildTool
{
    class CmakeCSharpProject
    {
        ...
        {
            string OutputData = "";
            string AllSourceFiles = CmakeGenerator.ArrayStringQuotes(Module.ModuleSourceFiles.ToArray());
            ...
            {
                OutputData += "add_dependencies(" + Module.ModuleName + " " + CmakeGenerator.ArrayStringQuotes(Module.ModuleDepends.ToArray()) + ")\n";
            }
            OutputData += "set_property(TARGET " + Module.ModuleName + " PROPERTY VS_DOTNET_TARGET_FRAMEWORK_VERSION \"v4.6.1\")\n";
            OutputData += "set_property(TARGET " + Module.ModuleName + " PROPERTY VS_DOTNET_REFERENCES \n  \"System\"  \n  \"System.Core\" \n   \"System.Data\" \"System.Data.DataSetExtensions\" \"System.Windows.Forms\" \"CSharpBridge\"  " + CmakeGenerator.ArrayStringQuotes(Module.NetReferences.ToArray()) + ")\n";
            return OutputData;
        }
    }
}
